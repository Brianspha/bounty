...
event __StatementCoverage(uint32 value);
    ...
    function userExists() external  returns(bool);
    ...
    function bountyExists(bytes32 bountyId) external  returns(bool);
    ...
    function bountyExpired(bytes32 bountyId) external  returns(bool);

    function pauseBounty(bytes32 bountyId) external returns(bool);

    function endDispute(bytes32 bountyId) external returns(bool);

    function getUserPostedBounties() external  returns(bytes32[] memory);

    function getUserRejectedBounties() external  returns(bytes32[] memory);

    function getUserAcceptedBounties() external  returns(bytes32[] memory);

    function getaddresseofBountyHunters(bytes32 bountyId) external  returns(address[] memory);
